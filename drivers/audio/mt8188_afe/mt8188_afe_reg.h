 ...
 */
/* Imported unchanged apart from this note and the two markers below; see REUSE.toml. */

#ifndef _MT8188_REG_H_
#define _MT8188_REG_H_

/*
 * Register offsets and field definitions transcribed from the datasheet, in
 * datasheet order.  Left formatted as imported so this file stays directly
 * comparable against the Linux original it came from, which is what a reader
 * checking a register offset needs.  Reflowing it would align every value to
 * the longest name in the file and lose that correspondence.
 */
/* clang-format off */
